                    ...
                    <div className="row">
                        <div className="form-group col-sm-6">
                            <li className='list-group-item text-capitalize rounded'>
                                ...
                                <p style={{textTransform: 'none'}}>{service.details}</p>
                            </li>
<<<<<<< HEAD
                            <li className='list-group-item text-capitalize rounded'>
                                <img id="icons" src="/images/icons/icon_bread32.png"/>{service.breed} {service.animal_type}
                            </li>
                            <li className='list-group-item text-capitalize rounded'>
                                <img id="icons" src="/images/icons/icon_gender32.png"></img>{service.gender}
                            </li>
                            <li className='list-group-item text-capitalize rounded'>
                                <img id="icons" src="/images/icons/icon_bday32.png"/>{service.age} {service.age_unit} old
                            </li>
                            <li className='list-group-item text-capitalize rounded'>
                                <img id="icons" src="/images/icons/icons8-stethoscope-32.png"/>Health History: {services.health_history}
                            </li>
                            <li className='list-group-item text-capitalize rounded'>
                                <button type='submit' className='btn btn-success mx-2 my-1'>
                                    <a href={`/services/${service._id}/edit`} className="text-decoration-none text-white" onClick={EditService}>
=======
                            <li className='list-group-item text-capitalize rounded m-2'>
                                <img id="icons" src="/images/icons/icon_bread32.png"/>{service.breed} {service.animal_type}
                            </li>
                            <li className='list-group-item text-capitalize rounded m-2'>
                                <img id="icons" src="/images/icons/icon_gender32.png"></img>{service.gender}
                            ...
                            <li className='list-group-item text-capitalize rounded'>
                                <button type='submit' className='edit-custom-btn mx-2 my-2'>
                                    <a href={`/services/${service._id}/edit`} className="text-decoration-none text-white" onClick={editService}>
...
<<<<<<< HEAD
                                {/* <form method='POST' action={`/services/${services._id}?_method=DELETE`}> */}
                                    <button onCLick={deleteService} type='submit' className='btn btn-danger  mx-2 my-1'>
=======
                                <form method='POST' action={`/services/${service._id}?_method=DELETE`}>
                                  <button onClick={deleteService} type='submit' className='delete-custom-btn mx-2 my-1 text-decoration-none text-white'>
>>>>>>> 802ff3ba0fb7913a5f2463469b95ed0813808c49
                                        <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" style={{ fill: 'white' }} className="bi bi-trash3-fill" viewBox="0 0 16 16">
                                            <path d="M11 1.5v1h3.5a.5.5 0 0 1 0 1h-.538l-.853 10.66A2 2 0 0 1 11.115 16h-6.23a2 2 0 0 1-1.994-1.84L2.038 3.5H1.5a.5.5 0 0 1 0-1H5v-1A1.5 1.5 0 0 1 6.5 0h3A1.5 1.5 0 0 1 11 1.5Zm-5 0v1h4v-1a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5ZM4.5 5.029l.5 8.5a.5.5 0 1 0 .998-.06l-.5-8.5a.5.5 0 1 0-.998.06Zm6.53-.528a.5.5 0 0 0-.528.47l-.5 8.5a.5.5 0 0 0 .998.058l.5-8.5a.5.5 0 0 0-.47-.528ZM8 4.5a.5.5 0 0 0-.5.5v8.5a.5.5 0 0 0 1 0V5a.5.5 0 0 0-.5-.5Z"/>
                                        </svg>Delete</button>
                        ...
                        <div className="form-group col-sm-6">
                            <li className='list-group-item text-capitalize rounded'>
                                ...
                                <form action={`/services/${service._id}/comment`} method="POST">
                                    <div className="mt-2">
